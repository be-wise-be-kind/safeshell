# How to Use Roadmaps in SafeShell
...
Replace `[feature-name]` with your feature name (use kebab-case, e.g., `command-evaluation`).
...
2. **Add commit hash to Notes column**:
   ...
   # Example: "Command parser added (commit c124b88)"
   ```
...
### Directory Structure
```
.roadmap/in-progress/command-evaluation/
├── PROGRESS_TRACKER.md    # Current: PR3 - Plugin System
├── PR_BREAKDOWN.md        # 5 PRs total with detailed steps
└── AI_CONTEXT.md          # Security architecture, evaluation flow
```

### Typical Workflow
1. User: "Create a roadmap for command evaluation"
2. AI creates roadmap in planning/command-evaluation/
3. Together break down into 5 PRs
4. User reviews and approves
5. Move to in-progress/command-evaluation/
...
9. Move to complete/command-evaluation/
